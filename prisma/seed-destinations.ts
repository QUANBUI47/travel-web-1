  ...
  const destinations = [
    {
      ...
      slug: "ha-long-bay",
      description:
        "Kỳ quan thiên nhiên thế giới với hàng ngàn đảo đá vôi kỳ vĩ và hang động độc đáo.",
    ...
    },
    {
      ...
      slug: "hanoi",
      description:
        "Thủ đô ngàn năm văn hiến với Hồ Gươm, Phố Cổ và nét ẩm thực tinh tế.",
    ...
    },
    {
      ...
      slug: "sapa",
      description:
        "Thị trấn trong sương với những ruộng bậc thang tuyệt đẹp và đỉnh Fansipan hùng vĩ.",
    ...
    },
    {
      ...
      slug: "da-nang",
      description:
        "Thành phố biển năng động với Cầu Vàng, Bà Nà Hills và bãi biển Mỹ Khê.",
    ...
    },
    {
      ...
      slug: "hoi-an",
      description:
        "Di sản văn hóa thế giới với những con phố vàng rực và ánh đèn lồng lung linh.",
    ...
    },
    {
      ...
      slug: "hue",
      description:
        "Vẻ đẹp tĩnh lặng và cổ kính của kinh thành xưa bên dòng sông Hương thơ mộng.",
    ...
    },
    {
      ...
      description:
        "Trung tâm kinh tế sầm uất mang vẻ đẹp trẻ trung, hiện đại và không bao giờ ngủ.",
    ...
    },
    {
      ...
      slug: "phu-quoc",
      description:
        "Thiên đường nghỉ dưỡng với biển xanh, cát trắng và những khu vui chơi giải trí đẳng cấp.",
    ...
    },
    {
      ...
      slug: "can-tho",
      description:
        "Thủ phủ vùng sông nước Cửu Long với chợ nổi Cái Răng và vườn trái cây trĩu quả.",

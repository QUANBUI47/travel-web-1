...
export const Footer = () => {
  return (
    <footer id="footer" className="w-full bg-slate-50 dark:bg-slate-900/50 pt-16 pb-8 border-t border-divider">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex gap-4">
              <Link href="#" className="w-11 h-11 rounded-xl bg-white dark:bg-slate-800 shadow-sm flex items-center justify-center text-gray-400 hover:text-primary transition-all border border-gray-100 dark:border-white/5 hover:-translate-y-1">
                <Facebook size={20} />
              </Link>
              <Link href="#" className="w-11 h-11 rounded-xl bg-white dark:bg-slate-800 shadow-sm flex items-center justify-center text-gray-400 hover:text-primary transition-all border border-gray-100 dark:border-white/5 hover:-translate-y-1">
                <Instagram size={20} />
          ...
          <div className="flex flex-col gap-6">
            ...
            <ul className="flex flex-col gap-3">
              {["Vịnh Hạ Long", "Phố cổ Hội An", "Đảo ngọc Phú Quốc", "Ruộng bậc thang Sapa", "Cố đô Huế"].map((item) => (
                <li key={item}>
                  <Link href="#" className="text-default-500 hover:text-primary text-sm font-medium transition-colors">
                    {item}
                  </Link>
                </li>
              ))}
          ...
          <div className="flex flex-col gap-6">
            ...
            <ul className="flex flex-col gap-3">
              {["Trung tâm trợ giúp", "Chính sách hoàn tiền", "Điều khoản dịch vụ", "Chính sách bảo mật", "Liên hệ hợp tác"].map((item) => (
                <li key={item}>
                  <Link href="#" className="text-default-500 hover:text-primary text-sm font-medium transition-colors">
                    {item}
                  </Link>

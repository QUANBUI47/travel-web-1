  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex flex-col gap-1">
        <h1 className="text-3xl font-black tracking-tight text-slate-800 uppercase">Hệ thống</h1>
        <p className="text-slate-500 font-medium text-sm">Quản lý trạng thái vận hành và các thiết lập toàn cục.</p>
      </div>
